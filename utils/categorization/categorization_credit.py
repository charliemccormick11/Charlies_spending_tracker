...
#Need to figure this out, get rid of the remaining line and change it to where if the categorys in the column for chase are different, then to 
    ...
    if st.session_state.credit_card == "Other":
        ...
        st.session_state.categorized_transactions_returning = processed_nonchase_df[processed_nonchase_df["Category"].isin(chase_categories)]
        st.session_state.remaining_transactions_returning = processed_nonchase_df[~processed_nonchase_df["Category"].isin(chase_categories)]
